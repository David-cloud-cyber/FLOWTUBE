var HFComponents = (function(exports, react, react_dom_client, react_jsx_runtime) {
	...
	var FileIcon = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		width: "13",
		height: "13",
		viewBox: "0 0 24 24",
		fill: "none",
	...
	var VideoIcon = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		width: "13",
		height: "13",
		viewBox: "0 0 24 24",
		fill: "none",
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
			...
			height: "14",
			rx: "2"
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m22 8-6 4 6 4V8z" })]
	});
	var AudioIcon = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		width: "13",
		height: "13",
		viewBox: "0 0 24 24",
		fill: "none",
	...
	function Thumb({ attachment }) {
		if (attachment.type === "image" && attachment.url) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
			src: attachment.url,
			alt: attachment.name,
			loading: "lazy",
			decoding: "async",
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			children: {
				image: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileIcon, {}),
				video: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(VideoIcon, {}),
				audio: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AudioIcon, {}),
				file: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileIcon, {})
			}[attachment.type]
		});
	}
	function Attachment({ attachment, variant: variantProp, onRemove }) {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
			...
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Thumb, { attachment }),
	...
	function AttachmentList({ variant = "compact", children, style, ...rest }) {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AttachmentListContext.Provider, {
			value: { variant },
	...
	*/
	function mountAttachments(container, attachments) {
		...
		const render = () => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AttachmentList, { children: attachments.map((a) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Attachment, {
			variant: "compact",
			attachment: a,
			onRemove: a.onRemove
		}, `${a.name}-${a.type}`)) });
